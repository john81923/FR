...
def parse_args():
    ...
    parser.add_argument('--upsample', help='partial_freeze', action='store_true')
    parser.add_argument('--upsample_child', help='partial_freeze', action='store_true')
...
from ..train.train_nir import run
#from ..train.gen_rgb_head import run
#from ..train.gen_end2end import run
#from ..train.gen_target_model import run
