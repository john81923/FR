from ..model.resnet import ResNet50Backbone, resnet50
...
if __name__ == '__main__':
    ...
    model2 = resnet50(args)
    model2.load_state_dict(torch.load('/mnt/storage1/craig/kneron_fr/rgb/resnet_origin_state_dict.tar'))
    model2.eval()
