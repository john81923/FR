...
def test_yuv422(rgb_image_path, nir_image_path, index = ""):
    ...
    if len(dets)>0:
        ...
        #cv2.imwrite("testing/0129_issue/result/output_0123_size_140_112_"+str(index)+".png", img_bgr_restored_nir)
        cv2.imwrite("testing/0129_issue/hebei_datang_rgb_output/"+ str(os.path.basename(nir_image_path)[:-4]) +".png", img_bgr_restored_nir)
...
if __name__ == "__main__":
    ...
    for ext in ('*.bmp', '*.png', '*.jpg'):
        ...
        image_list.extend(sorted(glob.glob(os.path.join('/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/0129_issue/hebei_datang_rgb', ext))))
