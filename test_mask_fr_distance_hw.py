...
#                            "./FD_SSD/models/anchor_face_ssd7s_cfg2.npy", score_thres=0.5, only_max=False)
face_detector = FdSsdRunner("/mnt/models/FD_models/fd_ssd/ssd7_mask_epoch-57_loss-0.1850_val_loss-0.1916.h5",
                            "./FD_SSD/models/anchor_face_ssd7s_cfg2.npy", score_thres=0.5, only_max=False)
...
def embedding(image_path):
    ...
    if len(dets)>0:
        ...
        cv2.imwrite("testing/david_out.jpg", resized_img)
...
if __name__ == "__main__":
    ...
    #test_path = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/0112_mask_fr_issue/david.jpg"
    test_path = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/0112_mask_fr_issue/vitali.jpg"
