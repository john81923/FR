...
#fr_runner = FrRunner(model_path='/mnt/models/FR_models/FR_RGB_Craig/0930_versions/resnet_mi8_v12_16_3_state_dict.tar',
#                         input_shape=[112, 112])

fr_runner = FrRunner(
         model_path='/mnt/models/FR_models/FR_RGB_Craig/102120_fr/resnet_mi8_v12_16_3_state_dict.tar',
         model_def_path='/mnt/models/FR_models/FR_RGB_Craig/102120_fr/target_model_def.py',
         module_name='get_model',
         input_shape=[112, 112],
     )
...
def embedding_hw(image_path):
    ...
    if len(dets)>0:
        ...
        #exit()
        #resized_img_np = np.expand_dims(resized_img_np, axis=-1)
        assert len(image_size) == 2
        resized_img = cv2.warpAffine(img, M, (image_size[1], image_size[0]), borderValue=0.0)


        resized_img_np = np.asarray(resized_img, dtype='f') #112x112x3
        resized_img_np = np.expand_dims(resized_img_np, axis=0)
        normed_emb_ori = fr_runner.run(image_path, resized_img_np)
...
if __name__ == "__main__":
    ...
    #img1 = "/home/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/00001_0001.png"
    #img1 = ""/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/RGB_test/"
    #img1 = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/RGB_test/rgb_1.png"
    #img2 = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/RGB_test/rgb_3.png"
    #img1 = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/RGB_test/RGB_2020-09-22-02-41-59-529.png"
    #img1 = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/face_occulusion.jpeg"
    #img1 = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/mouth_occ.jpg"


    #img2 = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/RGB_test/RGB_2020-09-22-02-45-46-251.png"
    #img1 = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/NIR_test/nir_1.png"
    #img2 = "/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/NIR_test/nir_3.png"
    #'''
    '''
    w=h=112
    ...
    #'''
    img1 = '/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/020821_issue/0208_3.jpg'
    img2 = '/mnt/sdd/craig/home_craig/kneron_tw_models/framework/face_recognition/kfr/testing/020821_issue/0208_4.jpg'
    print ("img1: ", img1)
    #embedding1= embedding(img1)
    embedding1, bad_angle_register_hw, bad_pose_register_hw = embedding_hw(img1)

    print ("img2: ", img2)
    #embedding2= embedding(img2)
    embedding2, bad_angle_register_hw, bad_pose_register_hw = embedding_hw(img2)
    ...
    #embedding_register, bad_angle_register, bad_pose_register = embedding(test_path)
    embedding_register_hw, bad_angle_register_hw, bad_pose_register_hw = embedding_hw(test_path)
    #print(embedding_register)
    #print(embedding_register_hw[0]) first batch
    print(embedding_register_hw[0]-embedding_register)
    exit(0)
