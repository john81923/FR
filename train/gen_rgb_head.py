...
from ..model.resnet import  Head, ResNet50Backbone, RGBHead
...
def train_net(args):
    ...
    if (args.finetune):
        ...
        if args.checkpoint is None:
            ...
            backbone, head, metric_fc_nir, optimizer, rgb_head = load_checkpoint_nir(args, train_loader.dataset.num_labels)
            save_checkpoint_rgbhead(rgb_head)
            exit(0)
            start_epoch = 0
            epochs_since_improvement = 0
