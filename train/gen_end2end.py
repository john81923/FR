...
from ..model.resnet import  Head, ResNet50Backbone, RGBHead, Merged
...
def load_checkpoint_nir(args, num_labels):
    ...
    full_net = Merged(model, nir_head)
    full_net.eval()
    torch.save(full_net, '/mnt/storage1/craig/kneron_fr/full_net/merged_v23.tar')
    exit(0)
    #print(net)
